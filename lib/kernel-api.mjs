...
export { ingestContent, resolveIngestRoute } from "./ingest-pipeline.mjs";
 ...
 */
export function createKernelContext({ workspaceRoot, engineRoot, contract, aiProvider }) {
  ...
  return {
    ...
    rebuildAllDerived(opts = {}) {
      return _rebuildAllDerived({ workspaceRoot, contract: getContract(), aiProvider, ...opts });
    },
    buildTopicDerived(opts = {}) {
      return _buildTopicDerived({ workspaceRoot, aiProvider, ...opts });
    },
    buildPeriodDerived(opts = {}) {
      return _buildPeriodDerived({ workspaceRoot, aiProvider, ...opts });
    },
    runOperation(opts = {}) {

 ...
 * Delete/archive use separate trash/archive paths (always high-impact unless permanent).
 *
 ...
 * - Delete / archive: handled in executeDelete / executeArchive (trash copy
 *   + receipt unless permanent=true).

...
| skill-first Desktop agent | ai-prompts · skills-runtime（agent 循环 `pi-agent-core`；LLM providers AI SDK v7；会话压缩默认 240K/60 且按模型 contextWindow 动态缩放；默认模型 gpt-4o-mini / gemini-3.6-flash / claude-sonnet-5 / grok-3-mini） |

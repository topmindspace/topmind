...
> **Chrome 行已覆盖（2026-09-07）**：本 ADR 把「搜索」写成 PrimaryNav 第四锚、记一下/💡 写在标题栏。现行 chrome：主锚 动态/收件箱/写出来；搜索=⌘K/⌘P；记一下在左栏；建议/清单/应用在右列 AI 工作区。词汇 High（动态≠工作台、记下≠记一下、Clip 不教 lite）仍有效。

...
> 产品入口：根 `README.md`（简体中文）· `README.en.md`（English）；Skills 模块 README 同此约定。  
> 路由：`读契约 → 哪个类别？哪个专题？哪个对象？什么动作？`  
> Pack 版本：`topmind-skills` 仓 [`topmind-pack.json`](https://github.com/topmindspace/topmind-skills/blob/main/topmind-pack.json)。  

...
export const WorkspaceService = {
  ...
  createDir: pathOps.createDir,
  copyFileTo: pathOps.copyFileTo,
  ...
  retireCoreMemory: pathOps.retireCoreMemory,
  updateCoreMemory: pathOps.updateCoreMemory,
  ...
  archiveStreamYear: pathOps.archiveStreamYear,

...
const STRINGS = {
  "zh-CN": {
    ...
    "pathOps.oldTextNoMatch": "oldText 在文件中未精确匹配（含空白/换行必须一致）。请先 read_file 再 edit_file。路径: {{path}}",
  ...
  "en-US": {
    ...
    "pathOps.oldTextNoMatch": "oldText not found exactly (whitespace/newlines must match). read_file before edit_file. Path: {{path}}",

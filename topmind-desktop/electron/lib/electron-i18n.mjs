 ...
 *   3. app.getPreferredSystemLanguages()[0] / app.getLocale() (OS locale)
 *   4. Default: "zh-CN"
 */
import { createRequire } from "node:module";

// ESM has no bare `require` — without this the Electron lookups below throw and
...
export const STRINGS = {
  "zh-CN": {
    ...
    "menu.exit": "退出",
    "menu.capture": "记一下…",
    "menu.globalCapture": "记一下（全局）…",
    "menu.search": "搜索…",
    "menu.commandPalette": "命令面板…",
    "menu.organizeWeek": "整理本周动态",
    "menu.openWorkspace": "打开工作区…",
    "menu.createWorkspace": "新建工作区…",
    "menu.switchWorkspace": "切换工作区…",
    "menu.recent": "最近打开",
    "menu.recentEmpty": "暂无最近工作区",
    "menu.refreshWorkspace": "重新载入工作区",
    "menu.revealWorkspace": "在文件管理器中显示",
    "menu.copyWorkspacePath": "复制工作区路径",
    "menu.closeWorkspace": "关闭工作区",
    "menu.viewStream": "动态",
    "menu.viewInbox": "Inbox",
    "menu.viewOutputs": "交付",
    "menu.viewArchive": "归档",
    "menu.sidebarView": "侧栏视图",
    "menu.sidebarStream": "列表",
    "menu.sidebarCategory": "分类",
    "menu.sidebarTimeline": "时间线",
    "menu.sidebarTags": "标签",
    "menu.sidebarKanban": "看板",
    "menu.aiPanelTabs": "AI 工作区面板",
    "menu.aiChat": "对话",
    "menu.aiSuggest": "建议",
    "menu.aiTodo": "清单",
    "menu.aiApps": "应用",
    "menu.toggleSidebar": "显示侧栏",
    "menu.toggleAi": "显示 AI 工作区",
    "menu.focusMode": "专注模式",
    "menu.back": "后退",
    "menu.forward": "前进",
    "menu.split": "对照分栏",
    ...
    "menu.themeDark": "深色",
    "menu.language": "语言",
    "menu.localeAuto": "跟随系统",
    "menu.localeZh": "简体中文",
    "menu.localeEn": "English",
    "menu.reload": "重新载入",
    ...
    "menu.bringFront": "前置全部窗口",
    "menu.services": "服务",
    "menu.hide": "隐藏 topmind",
    "menu.hideOthers": "隐藏其他",
    "menu.unhide": "全部显示",
    "menu.quitApp": "退出 topmind",
    "menu.undo": "撤销",
    "menu.redo": "重做",
    "menu.cut": "剪切",
    "menu.copy": "复制",
    ...
    "ai.cancelled": "用户取消。",
    "ai.timeout": "超时（15 分钟）。",
    "ai.stalled": "中断（180 秒无数据，可能是工具链过长）。",
    "ai.steer": "[用户中途指示 · 立即遵从，可中止原计划中未完成步骤]\n{{body}}",
    "ai.stepLimit": "[系统] 步骤将尽：优先完成当前目标并给出路径回执；勿再开无关大范围搜索。",
    "ai.stepNudge": "[系统] 步数接近上限：请继续完成当前任务的核心步骤，给出路径回执；勿开无关大范围探索。",
    "ai.continuePrompt": "[系统] 上一轮步数用尽，任务可能未完成。请基于最近的工具结果与路径回执，继续完成用户原始目标；若已完成则给出简短结论与路径。",
    ...
    "pathOps.editMdOnly": "仅支持编辑文本类文件（.md / .txt / .json / 代码等）。",
    "pathOps.saveTextOnly": "仅支持写入文本类文件（.md / .txt / .json / 代码等）；二进制资源请用 saveBinary。",
    ...
    "pathOps.hashMismatch": "文件在读取后已被修改（expectedHash 不匹配）: {{path}}。请先 read_file 刷新 contentHash 与 oldText 再重试。",
    ...
    "pathOps.writeDenied": "写入被拒绝: {{reason}}",
  ...
  "en-US": {
    ...
    "menu.about": "About & Updates",
    "menu.checkUpdates": "Check for Updates…",
    "menu.settings": "Settings…",
    "menu.exit": "Quit",
    "menu.capture": "Note it…",
    "menu.globalCapture": "Note it (global)…",
    "menu.search": "Search…",
    "menu.commandPalette": "Command Palette…",
    "menu.organizeWeek": "Organize This Week",
    "menu.openWorkspace": "Open Workspace…",
    "menu.createWorkspace": "New Workspace…",
    "menu.switchWorkspace": "Switch Workspace…",
    "menu.recent": "Open Recent",
    "menu.recentEmpty": "No recent workspaces",
    "menu.refreshWorkspace": "Reload Workspace",
    "menu.revealWorkspace": "Reveal in File Manager",
    "menu.copyWorkspacePath": "Copy Workspace Path",
    "menu.closeWorkspace": "Close Workspace",
    "menu.viewStream": "Stream",
    "menu.viewInbox": "Inbox",
    "menu.viewOutputs": "Delivery",
    "menu.viewArchive": "Archive",
    "menu.sidebarView": "Sidebar Layout",
    "menu.sidebarStream": "List",
    "menu.sidebarCategory": "Categories",
    "menu.sidebarTimeline": "Timeline",
    "menu.sidebarTags": "Tags",
    "menu.sidebarKanban": "Board",
    "menu.aiPanelTabs": "AI Workspace Pane",
    "menu.aiChat": "Chat",
    "menu.aiSuggest": "Suggestions",
    "menu.aiTodo": "AI list",
    "menu.aiApps": "Apps",
    "menu.toggleSidebar": "Show Sidebar",
    "menu.toggleAi": "Show AI Workspace",
    "menu.focusMode": "Focus Mode",
    "menu.back": "Back",
    "menu.forward": "Forward",
    "menu.split": "Split View",
    "menu.taskPanel": "Task Panel",
    "menu.todo": "Personal list",
    "menu.appearance": "Appearance",
    "menu.themeAuto": "Follow System",
    "menu.themeLight": "Light",
    "menu.themeDark": "Dark",
    "menu.language": "Language",
    "menu.localeAuto": "Follow System",
    "menu.localeZh": "简体中文",
    "menu.localeEn": "English",
    "menu.reload": "Reload",
    ...
    "menu.bringFront": "Bring All to Front",
    "menu.services": "Services",
    "menu.hide": "Hide topmind",
    "menu.hideOthers": "Hide Others",
    "menu.unhide": "Show All",
    "menu.quitApp": "Quit topmind",
    "menu.undo": "Undo",
    "menu.redo": "Redo",
    "menu.cut": "Cut",
    "menu.copy": "Copy",
    ...
    "ai.timeout": "Timeout (15 minutes).",
    "ai.stalled": "Stalled (180s no data, possibly tool chain too long).",
    ...
    "ai.stepNudge": "[System] Near step budget: keep finishing the current task's core steps and return path receipts; avoid unrelated exploration.",
    "ai.continuePrompt": "[System] Step budget was exhausted; the task may be incomplete. Continue from the latest tool results and path receipts toward the user's original goal; if finished, give a short conclusion with paths.",
    ...
    "pathOps.editMdOnly": "Only text files can be edited (.md / .txt / .json / code / config).",
    "pathOps.saveTextOnly": "Only text files can be written (.md / .txt / .json / code / config). Use saveBinary for binary assets.",
    ...
    "pathOps.hashMismatch": "File changed since last read (expectedHash mismatch): {{path}}. Re-read with read_file to refresh contentHash/oldText, then retry.",
    ...
    "pathOps.writeDenied": "Write denied: {{reason}}",
 ...
 *
 * 2026-09-14 fix: this module is ESM, so the bare `require("electron")` below
 * threw a ReferenceError on every call and was swallowed by the catch — which
 * meant `app.getLocale()` never ran and every English-locale user fell through
 * to the zh-CN default. Invisible while the main process only localised the
 * tray; loudly wrong now that the native menu bar (labels, checkmarks, the
 * whole 视图/工作区 surface) is main-process i18n.
 */
function resolveLocale() {
  ...
  try {
    ...
    // getPreferredSystemLanguages first: it reports the user's ordered list,
    // which is what "follow system" should mean when the UI locale is unset.
    const preferred = app?.getPreferredSystemLanguages?.();
    if (Array.isArray(preferred) && preferred.length > 0) {
      return matchLocale(String(preferred[0]));
    }

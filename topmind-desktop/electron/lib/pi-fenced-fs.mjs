/**
 * Pi-native FS tools (read / write / edit) mapped onto the workspace fence.
 *
 * Desktop's target agent loop is `@earendil-works/pi-agent-core` (not the full
 * coding-agent kernel). Pi default `bash` stays OFF. Every path is resolved
 * against the current workspace root; outside writes/reads are denied here
 * before Kernel writeback / evaluateOutsideRead.
 */
import path from "node:path";

export const PI_NATIVE_FS_TOOLS = Object.freeze(["read", "write", "edit"]);
 ...
 */
export function resolvePiToolPath(workspaceRoot, rawPath) {

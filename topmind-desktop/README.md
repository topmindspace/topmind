...
<p align="center">
  <sub>如果您的环境无法自动播放，可直接下载或播放 <a href="../docs/images/topmind-demo.mp4">HD MP4 高清演示视频</a></sub>
</p>
...
#### 方式一：Homebrew 安装 (macOS 推荐 · 一键解隔离免报错)
```bash

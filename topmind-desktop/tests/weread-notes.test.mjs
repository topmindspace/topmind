...
test("weread-service uses official helpers and does not filter by lastSyncAt", async () => {
  ...
  const skillPath = [
    process.env.TOPMIND_SKILLS_SRC && path.join(process.env.TOPMIND_SKILLS_SRC, "topmind-weread/SKILL.md"),
    fileURLToPath(new URL("../../../topmind-skills/topmind-weread/SKILL.md", import.meta.url)),
    fileURLToPath(new URL("../../topmind-skills/topmind-weread/SKILL.md", import.meta.url)),
    fileURLToPath(new URL("../../skills/topmind-weread/SKILL.md", import.meta.url)),
  ].filter(Boolean).find((p) => { try { return existsSync(p); } catch { return false; } }) || fileURLToPath(new URL("../../../topmind-skills/topmind-weread/SKILL.md", import.meta.url));

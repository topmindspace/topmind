...
import {
  listRowClass, ViewContainer, SectionHeader, EmptyState, LoadingState, ErrorState,
        ...
        actions={
          <>
            <Button
              variant="outline"
              size="sm"
              disabled={!ready} softDisabled={syncing}
            ...
            <Button
              variant="outline"
              size="sm"
              disabled={!ready || selected.size === 0} softDisabled={syncing}

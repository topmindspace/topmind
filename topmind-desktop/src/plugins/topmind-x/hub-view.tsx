      ...
      <section className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button
            size="sm"
            variant="outline"
            disabled={!canRead || !query.trim()} softDisabled={fetching}
          ...
          <Button
            size="sm"
            disabled={selected.size === 0} softDisabled={archiving}
        ...
        {!canPost ? (
          ...
          <div className="v4-dash-card space-y-2 p-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <Button
                size="sm"
                disabled={!postText.trim() || charCount > 280} softDisabled={posting}

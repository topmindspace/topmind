...
<style>
  /* Palette mirrors Desktop Design System 4.0 */
  ...
  @media (prefers-color-scheme: dark) {
    body { color: #d8d8d8; background: #161616; }
  ...
  :not(pre) > code { padding: 0.1em 0.35em; border-radius: 4px; background: #e8e8e8; }
  blockquote {
    margin: 1em 0;
    padding-left: 1em;
    border-left: 3px solid rgba(3, 105, 161, 0.45);
    color: #4e4e4e;
  }
  @media (prefers-color-scheme: dark) {
    blockquote { border-left-color: rgba(56, 189, 248, 0.5); color: #bcbcbc; }
    pre { background: #1f1f1f; }
    :not(pre) > code { background: #1f1f1f; }
  }
  a { color: #0369a1; }
  .meta { font-size: 0.85rem; color: #6a6a6a; }
  @media (prefers-color-scheme: dark) { .meta { color: #969696; } }

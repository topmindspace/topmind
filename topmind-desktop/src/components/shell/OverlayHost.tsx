    ...
    <OverlayPortalContext.Provider value={portalEl}>
      <div
        ...
        className={cn(
          ...
          "v4-no-drag isolate fixed inset-0 z-modal flex justify-center animate-fade-in",
          // Mini-apps (ledger): light scrim so the workbench stays readable
          // behind the sheet — full black felt "covered". Other overlays keep
          // the denser modal scrim for form/dialog focus.
          isMiniApp ? "bg-scrim-mini" : "bg-scrim",
      ...
      >
        ...
        >
          <LazyBoundary
            className={cn(
              "min-h-[6rem] min-w-[14rem] p-4",
              isMiniApp
                ? "rounded-[var(--radius-dialog)] bg-transparent p-0"

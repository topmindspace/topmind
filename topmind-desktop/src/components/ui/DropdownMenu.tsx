...
export function DropdownItem({
  ...
  children: ReactNode;
  onSelect: () => void;
  /** Hard off — not focusable, not clickable. */
  disabled?: boolean;
  /**
   * MD3 soft-disabled: looks off but stays keyboard-focusable so menu structure
   * stays discoverable (e.g. "why is this unavailable?"). Click is swallowed.
   */
  ...
  const off = Boolean(disabled || softDisabled);
  return (
    <button
      type="button"
      role="option"

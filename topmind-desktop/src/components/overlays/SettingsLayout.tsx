...
const TAB_DESC_KEYS: Record<string, string> = {
  ...
  companions: "settings:tabDesc.companions",
  about: "settings:tabDesc.about",
...
const TAB_HELP_KEYS: Record<string, string> = {
  ...
  companions: "settings:tabHelp.companions",
  about: "settings:tabHelp.about",
...
export function SettingsLayout({
  ...
  /** Filter left nav — lowers scan cost across 环境/智能体/扩展/关于 */
  ...
  // Group labels for nav (环境 / 智能体 / 扩展 / 关于)

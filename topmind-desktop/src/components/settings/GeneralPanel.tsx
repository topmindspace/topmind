...
export function GeneralPanel({
  ...
  return (
    <div>
      ...
      {/* Cross-links: 扩展与集成 / 关于与更新 — keep maintenance reachable from 通用 */}
      <div className="mt-3 flex items-center justify-between gap-2 rounded-[var(--radius-md)] border border-border-subtle-dim bg-surface px-3 py-2">
        <div className="min-w-0 text-3xs text-text-quaternary">

 ...
 *   common · shell · settings · editor · ai · workspace · ingest · weread · x · ledger · wechat · overlays
 */
...
import zhCNWechat from "./zh-CN/wechat.json";
...
import enUSWechat from "./en-US/wechat.json";

...
const STRINGS = {
  "en-US": {
    ...
    "error.appendTopicMemoryParams": "append-topic-memory requires --category and --topic",
    "error.appendTopicMemoryEntry": "append-topic-memory requires --entry",
    ...
    "error.appendCoreMemoryEntry": "append-core-memory requires --entry",
  ...
  "zh-CN": {
    ...
    "error.appendTopicMemoryParams": "append-topic-memory 需要 --category 和 --topic",
    "error.appendTopicMemoryEntry": "append-topic-memory 需要 --entry",
    ...
    "error.appendCoreMemoryEntry": "append-core-memory 需要 --entry",

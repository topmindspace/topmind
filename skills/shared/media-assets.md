...
| 落点 | `dest` | 笔记示例 | 图片目录 |
|------|--------|----------|----------|
| Inbox | **role:buffer**（常 `00-Inbox/` / `00-Inbox/`） | `{buffer}/2026-07-21-foo.md` | `{buffer}/images/{slug}/` |
| 类别根 | `20-研究/` | `20-研究/散记.md` | `20-研究/images/{slug}/` |
| 专题 | `20-研究/2026-主题/` | `…/note.md` | `…/images/{slug}/` |
| 交付 | `88-交付/` | `88-交付/YYYY-MM-DD-标题.md` | `88-交付/images/{slug}/`（发布时复制） |
...
| **发布交付副本** | **保留** | **复制**到 `88-交付/images/` | 在 `88-交付/` 生成扁平 `YYYY-MM-DD-标题.md`；需用户确认 |
| **删除笔记** | 普通开放笔记 **unlink，无 trash**；锁定 / 专题首页 / 交付 才进归档 | 关联 `images/{slug}/` 随笔记走同一闸 | 用户文案不得声称每次删除都进 99-归档 |

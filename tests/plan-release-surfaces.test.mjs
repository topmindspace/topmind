...
test("only changed surfaces pack; unchanged reuse previous assets", () => {
  const current = { desktop: "3.4.1", extension: "3.4.0" };
  const previous = { desktop: "3.4.0", extension: "3.4.0" };
...
test("readPreviousLatest reads finalize-release stamp; currentSurfaceVersions matches truth", () => {
  ...
  assert.equal(cur.skills, undefined, "skills ships in topmind-skills");
  assert.equal(cur.obsidian, undefined, "obsidian ships in topmind-obsidian");
});
